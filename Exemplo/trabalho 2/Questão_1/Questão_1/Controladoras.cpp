...
void CntrIntNavegacao::executar(){
    ...
    switch (escolha) {
        case OPCAO_PROJETOS: 
            {
            protocoloIntProjeto = new CntrIntProjeto;
        ...
        case OPCAO_MODULOS: 
            {
            protocoloIntModulo = new CntrIntModulo;
        ...
        case OPCAO_FASES: 
            {
            protocoloIntFase = new CntrIntFase;
        ...
        case OPCAO_METRICAS: 
            {
            protocoloIntMetrica = new CntrIntMetrica;
...
void CntrIntProjeto::executar(){
    ...
    protocoloProjeto = new StubProjeto;
    ...
    switch (escolha) {       
        ...
        case OPCAO_PESQUISAR: 
            ...
            Projeto projetoPesquisa(matricula, codigo_projeto, data_inicio, data_termino, nota);                  
            
            try {
                protocoloProjeto->pesquisar(&projetoPesquisa);
            }
            catch(invalid_argument& e){
                cout << e.what() << endl;
                cout<<"Pressione qualquer tecla para continuar."<<endl;
        ...
        case OPCAO_ATUALIZAR: 
            ...
            Projeto projetoAtualizar(matricula, codigo_projeto, data_inicio, data_termino, nota);                  
    
            try {
                protocoloProjeto->atualizar(projetoAtualizar);
            }
            catch(invalid_argument& e){
                cout << e.what() << endl;
                cout<<"Pressione qualquer tecla para continuar."<<endl;
...
void CntrIntModulo::executar(){
    ...
    protocoloModulo = new StubModulo;
    ...
    switch (escolha) {
        ...
        case OPCAO_PESQUISAR: 
            ...
            Modulo moduloPesquisa(codigo_modulo,nome_arquivo,tamanho);
            
            try {
            protocoloModulo->pesquisar(&moduloPesquisa);
            }
            catch(invalid_argument& e){
                cout << e.what() << endl;
                cout<<"Pressione qualquer tecla para continuar."<<endl;
        ...
        case OPCAO_ATUALIZAR: 
            ...
            Modulo moduloAtualizar(codigo_modulo,nome_arquivo,tamanho);
            
            try {
            protocoloModulo->atualizar(moduloAtualizar);
            }
            catch(invalid_argument& e){
                cout << e.what() << endl;
                cout<<"Pressione qualquer tecla para continuar."<<endl;
...
void CntrIntFase::opcoesFase(){  
    ...
    switch (escolha) {
        ...
        case OPCAO_ATUALIZAR: 
            ...
            Fase faseAtualizar(codigo_fase,tempo_estimado,tempo_efetivo);


            try {
                protocoloFase->atualizar(faseAtualizar);
            }
            catch(invalid_argument& e){
                cout << e.what() << endl;
                cout<<"Pressione qualquer tecla para continuar."<<endl;
...
void CntrIntMetrica::executar(){
    ...
    protocoloMetrica = new StubMetrica;
