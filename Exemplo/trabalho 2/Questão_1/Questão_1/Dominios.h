...
class Data_Inicio{
    private:
        void validar(unsigned int) throw (invalid_argument);
        unsigned int valor;
    public:
        Data_Inicio(){};
        Data_Inicio(unsigned int) throw (invalid_argument);
        void setValor(const unsigned int&) throw (invalid_argument);
 ...
 * \param valor
 */
inline void Data_Inicio::setValor(const unsigned int& valor)throw (invalid_argument){
    validar(valor);
    this->valor = valor;
}
 ...
 * \return valor
 */
inline unsigned int Data_Inicio::getValor() const{
    return valor;
}
...
class Data_Termino{
    ...
    public:
        Data_Termino(){};
        Data_Termino(unsigned int) throw (invalid_argument);
        void setValor(const unsigned int&) throw (invalid_argument);
        unsigned int getValor() const;
};
 ...
 * \param valor
 */
inline void Data_Termino::setValor(const unsigned int& valor)throw (invalid_argument) {
    validar(valor);
    this->valor = valor;
}
 ...
 * \return valor
 */
inline unsigned int Data_Termino::getValor() const{
    return valor;
}
...
class Nota{
    ...
    public:
        Nota(){};
        Nota (unsigned int) throw (invalid_argument);
        void setValor(const unsigned int&) throw (invalid_argument);
        unsigned int getValor() const;
};
 ...
 * \param valor
 */
inline void Nota::setValor(const unsigned int& valor) throw (invalid_argument){
    validar(valor);
    this->valor = valor;
}
 ...
 * \return valor
 */       
inline unsigned int Nota::getValor() const{
    return valor;
}
...
class Tamanho{
    ...
    public:
        Tamanho(){};
        Tamanho(unsigned int) throw (invalid_argument);
        void setValor(const unsigned int&) throw (invalid_argument);
        unsigned int getValor() const;
};
 ...
 * \param valor
 */
inline void Tamanho::setValor(const unsigned int& valor) throw (invalid_argument){
    validar(valor);
    this->valor = valor;
}
/**
 ...
 * \return valor
 */   
inline unsigned int Tamanho::getValor() const{
    return valor;
}
...
class Tempo{
    ...
    public:
        Tempo(){};
        Tempo(unsigned int) throw (invalid_argument);
        void setValor(const unsigned int&) throw (invalid_argument);
        unsigned int getValor() const;
};
 ...
 * \param valor
 */
inline void Tempo::setValor(const unsigned int& valor)throw (invalid_argument){
    validar(valor);
    this->valor = valor;
}
 ...
 * \return valor
 */   
inline unsigned int Tempo::getValor() const{
    return valor;
}
